...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Test création package Factorial",
    Description = "Ne pas utilser , c'est un test",
    `Authors@R` = c(
      person("Nande", "Mathis", email = "mathisnande@gmail.com", role = c("aut", "cre"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Nande Mathis")
```
